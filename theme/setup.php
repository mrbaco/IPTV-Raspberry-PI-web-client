...
<div class="info">
    ...
    <?php } ?>
    <p>
        Права на чтение и запись файла config.json, а также на запуск файлов run_player.sh и splash.sh были установлены автоматически. В случае, если что-то будет не работать, рекомендуется проверить их в первую очередь.
    </p>
